...
#define SQRT3 1.73205080756887729352744634150587236694280525381038062805580  /// SQRT(3)
        ...
        */
         ...
         * @param M rotation matrix
         */
        surface& generateBullet(double a, double h, double t, maths::Matrix<double> M = maths::UNITY); /// Generiert einen hexagonalen Zylinder mit Seitenl�nge a und H�he h und einer pyramidalen Spitze 
