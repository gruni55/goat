...
public:
	...
	void addLightSourceRRT(LightSrc* ls, Vector<std::complex<double> >Pol1, Vector<std::complex<double> >Pol2);
...
class Raytrace
{
  public:
	...
	Vector<double> PStart, PStop; ///< Start and end point of the last step
	Vector<std::complex<double> > EStart, EStop; ///< Start and end value of the electric field 
	Vector<std::complex<double> > EStart2, EStop2;  ///< Start and end value of the electric field (second ray in IRay)
...
class Raytrace_OT : public Raytrace
{
  public:
	  ...
	  Vector<double>* F; ///< list of the forces acting on the objects
	  Vector<double>* L; ///< angular momenta acting on the objects
	  Vector<double>** f; ///< list of the forces acting on the objects, separated for the different light sources
	  Vector<double>** l;///< list of the angular momenta acting on the objects, separated for the different light sources
};
...
class Raytrace_Path : public Raytrace
{
  public:
	...
	Vector<double>* P1; ///< Here, the starting points of each step are stored if no filename is given
	Vector<double>* P2; ///< Here, the ending points of each step are stored if no filename is given
