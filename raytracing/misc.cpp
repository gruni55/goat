...
void binWriteIncList (ofstream &os, ObjectShape **E, int anz)
{
...
void binWriteInc (ofstream &os, ObjectShape *E)
{
...
void binReadIncList (ifstream &is, ObjectShape **&E, int anz)
{
 int Anz;
...
void binReadInc (ifstream &is, ObjectShape *&E, bool isNew)
{
 int type;
