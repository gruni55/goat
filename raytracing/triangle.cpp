...
triangle::triangle(Vector<double> ip1, Vector<double> ip2, Vector<double> ip3)
{
...
Vector<double> triangle::getnorm(void)
{
	// setnorm();
	return n;
}

triangle::triangle(Vector<double> ip1, Vector<double> ip2, Vector<double> ip3, Vector<double> P0)
{
...
double triangle::distance(Vector<double> p,  Vector<double> k) 
{
 double t;
 Vector<double> pout;
...
int triangle::calcIntersectionPoint(Vector<double> r, Vector<double> k,
...
Vector<double>& triangle::operator[](int i)
{
	return P[i];
}

const Vector<double>& triangle::operator[](int i)
const
{
	return P[i];
}
...
triangle operator + (const triangle& dr, const Vector<double>& v)
{
	triangle h;
	h[0] = dr[0] + v;
	h[1] = dr[1] + v;
...
triangle operator + (const Vector<double>& v, const triangle& dr)
{
	triangle h;
	h[0] = v + dr[0];
	h[1] = v + dr[1];
...
triangle operator * (const Matrix<double>& M, const triangle& dr)
{
	triangle h;
	h[0] = M * dr[0];
	h[1] = M * dr[1];
