...
\begin{DoxyItemize}
\item The basic mathematical functions in the template classes Matrix and Vector, which describes three dimensional matrices and vector and the corresponding operators (the include files can be found in the folder \+: /maths)
...
take also a look into R\+E\+A\+D\+M\+E.\+txt\hypertarget{index_autotoc_md1}{}\doxysection{Installation instructions}\label{index_autotoc_md1}
...
change to your \mbox{\hyperlink{namespace_g_o_a_t}{G\+O\+AT}} directory type \char`\"{}cmake .\char`\"{} (don\textquotesingle{}t forget the dot!)
...
Newer versions of Visual Studio (e.\+g. VS 2019) supports cmake directly, so you can just open the \mbox{\hyperlink{namespace_g_o_a_t}{G\+O\+AT}} directory with VS
...
\begin{DoxyItemize}
\item {\bfseries{goat\+\_\+raytracing.\+lib}} \+: here are all the raytracing functions and representations
