...
take also a look into README.\+txt\hypertarget{index_autotoc_md1}{}\doxysection{Installation instructions}\label{index_autotoc_md1}
...
change to your \mbox{\hyperlink{namespace_g_o_a_t}{GOAT}} directory type \char`\"{}cmake .\char`\"{} (don\textquotesingle{}t forget the dot!)
...
Newer versions of Visual Studio (e.\+g. VS 2019) supports cmake directly, so you can just open the \mbox{\hyperlink{namespace_g_o_a_t}{GOAT}} directory with VS
