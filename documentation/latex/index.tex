...
\end{DoxyItemize}\end{quote}
\hypertarget{index_autotoc_md2}{}\doxysection{\texorpdfstring{XML Support}{XML Support}}\label{index_autotoc_md2}
Scenes and calculations can be stored in a XML file. More details can be found \doxysectlink{md__x_m_l}{here}{0} 