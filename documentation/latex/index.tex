\label{index_md_C__Users_Thomas_source_repos_raytracing_goat_release_GOAT}%
\Hypertarget{index_md_C__Users_Thomas_source_repos_raytracing_goat_release_GOAT}%
...
This part includes the raytracer and the description of the scene with the objects and light sources.\hypertarget{index_autotoc_md1}{}\doxysection{Installation instructions}\label{index_autotoc_md1}
For a proper installation, cmake is highly recommended. You can download it from \mbox{[}\mbox{]}(\href{https://cmake.org/}{\texttt{ https\+://cmake.\+org/}}) and of course, a working C++-\/\+Compiler (We tested it on Windows with Visual Studio Community Edition 2019 and on Linux with gcc)

open a console window a

change to your G\+O\+AT directory

type \char`\"{}cmake .\char`\"{} (don\textquotesingle{}t forget the dot!)
