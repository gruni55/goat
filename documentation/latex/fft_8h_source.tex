...
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00074}00074\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{void}\ setCurrNList(\textcolor{keywordtype}{double}\ wvl)}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00075}00075\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00076}00076\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ nList.size();\ i++)}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00077}00077\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ currNList[i]\ =\ nList[i](wvl);}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00078}00078\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00079}00079\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ void\ createLTexpo();}}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00080}00080\ \ \ \ \ \ \ \ \ \ \ \ \ std::complex<double>\ calcPhase(std::vector<stepEntry>\ steps,\ \textcolor{keywordtype}{double}\ k0);}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00081}00081\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_g_o_a_t_1_1maths_1_1_vector}{GOAT::maths::Vector<std::complex<double>}}\ >\ calcOne(std::vector<stepEntry>\ steps,\ \textcolor{keywordtype}{double}\ t);}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00082}00082\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{class_g_o_a_t_1_1maths_1_1_vector}{GOAT::maths::Vector<std::complex<double>}}\ >\ integrate(\textcolor{keywordtype}{double}\ t,\ std::vector<gridEntry>\ ge,\ \textcolor{keywordtype}{double}\ omegastart,\ \textcolor{keywordtype}{double}\ omegastop);}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00083}00083\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ twoSigma2;\ }
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00084}00084\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ sigma2;}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00085}00085\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ prefactor;\ \textcolor{comment}{//\ 1/(sigma\ *\ sqrt\ (2pi))}}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00086}00086\ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ double\ omegastart,\ omegastop;}}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00087}00087\ \ \ \ \ \ \ \ \ \ \ \ \ std::vector<double>\ freq;}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00088}00088\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{double}\ tref\ =\ 0.0;}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00089}00089\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{struct_g_o_a_t_1_1raytracing_1_1_trafo_parms}{TrafoParms}}\ tp;}
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00090}00090\ \ \ \ \ \ \ \ \ \ \ \ \ std::vector<std::complex<double\ >\ >\ currNList;\ }
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00091}00091\ \ \ \ \ \ \ \ \ \ \ \ \ std::vector<std::function<std::complex<double>(\textcolor{keywordtype}{double})\ >\ >\ nList;\ }
\DoxyCodeLine{\Hypertarget{fft_8h_source_l00092}00092\ \ \ \ \ \ \ \ \ \};}
