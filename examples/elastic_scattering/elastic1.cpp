...
int main(int argc, char** argv)
{
    ...
    LightSrcPlane LS (-300.0*ez, 10000, 1.0, 2.0*Rsphere,I*ey,LIGHTSRC_RAYTYPE_RAY);  // Setup of the incident plane wave
	...
	Raytrace_scattering R(S,900,180);	// initialise raytracer for elastic scattering
	R.setNumReflex(5);		// set number of internal reflections to 5
	R.trace();				// start raytracing 
	R.save("elastic1.dat",SAVE_ABS2);	// save results to file (squared absolute value of the electric field |E|²
	return 0;
}
