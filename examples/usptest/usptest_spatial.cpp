...
int main (int argc, char **argv)
{
	...
	int nCells = 20000000; //  number of cells in the virtual grid => resolution 0.1µm
	...
	*/
	...
	GOAT::raytracing::LightSrcPlane LS(P, nrays, 1.0, 10); // define Plane wave at P with nrays rays wavelength 1E-6 and size 10µm
