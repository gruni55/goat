...
int main(int argc, char* argv[])
{
   ...
   GOAT::raytracing::LightSrcPlane_mc LS(-GOAT::maths::ey * 100,nRays,1.0,100.0,Pol);
    LS.setk(GOAT::maths::ey);
   
    int nDet = 400;
    GOAT::raytracing::DetectorPlane D(GOAT::maths::Vector<double>(0, 1, 0), GOAT::maths::ey,100, nDet);
