...
\fontsize{10pt}{10pt}\selectfont
 ...
 \hline
  Filename & \parbox{2cm}{Prefix of the filename used to store the result. A file for each active object will be created in the form $<$Filename$><$object no.$>$.dat}. & any filename & -- \\
  \hline
  Spatial\_Resolution & resolution of the grid in \si{\micro\metre} & integer & $\frac{2\cdot r_0}{nn\footnote{number of elements per direction}}$ \\
  \hline 
