...
\begin{document}
 ...
 Beside the library, a setup can be done by using a XML-file. In such a file, all parts of the scene can be described and also calculations can be performed. The aim of this documentation is to give an overview how the parameters of the different elements can be defined. 
...
\begin{tabular}{p{2cm}|m{3.5cm}|m{3.0cm}|p{1.7cm}}
 ...
 \hline
 Dimension & Vector which hset (gca,'position',[0.1 0.1 0.75 0.75],'xlim',[-1000 1000],'ylim',[-1000 1000]);olds semi-axis along the x-, y- and z-direction & 3D Vector & (10,10,10) 
 \end{tabular}
%  \end{center}
 \subsection{Box}
 type: \textbf{box} \\
...
\begin{tabular}{p{2cm}|m{3.5cm}|m{3.0cm}|p{1.7cm}}
 Parameter  & description  & possible value & default value\\
 \hline
 Radius & Overall radius of the lens & double & 0 \\
 \hline
 Offset & Thickness of the lens\footnote{For more detailed description, refer to class GOAT::raytracing::sphericLens} & double & 0 \\
 \hline 
 left  & left side  & &\\
 right & right side & &\\
 \hline
 \hline
  \multicolumn{4}{c}{The following parameters belong to parameter left or right} \\
   \hline
 \hline
 Curvature & Type of curvature of the corresponding side & \parbox{2cm}{"flat","concave",\\"convex"} & flat\\
 \hline
 R & Radius of the curvature (only valid if Curvature is "concave" or "convex") & double & 0 \\
 \end{tabular}
\end{center} 
...
\fontsize{10pt}{10pt}\selectfont
 \begin{tabular}{c|m{3cm}|m{3cm}|c}
  Parameter name & description  & possible value & default value \\
 \hline
 Type & type of the calculation & "pure","path","pulse" & -- \\
 \hline
...
% \begin{tabular}{c|m{3cm}|m{3cm}|c}
 ...
 \hline
  ...
  \hline
  Spatial\_Resolution & resolution of the grid in \si{\micro\metre} & integer & 1 \\
  %$\frac{2\cdot r_0}{nn\footnote{number of elements per direction}}$
  \hline 
  Wavelength & Central wavelength in µm & double & $\SI{1}{\micro\metre}$ \\
  \hline
  NumReflexions & Number of reflections & integer & \tiny{INEL\_MAX\_NREFLEX (1)} \\
  \hline
  ...
  \hline
  NumSpectralRanges & Number of spectral ranges considered for calculation & 4 \\
  \hline    
% \end{tabular}
 \end{longtable}
